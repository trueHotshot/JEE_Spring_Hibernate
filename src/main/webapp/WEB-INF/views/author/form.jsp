...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <div class="card card-register mx-auto mt-5">
            <div class="card-header">Author form</div>
            <div class="card-body">
                <form:form modelAttribute="author" method="post"  id="contact_form">
                    ...
                    <form:errors path="firstName" cssClass="text-danger form-group row" element="div"/>
                    ...
                    <form:errors path="lastName" cssClass="text-danger form-group row" element="div"/>

                    <div class="form-group row">
                        <label class="col-md-2 control-label">PESEL:</label>
                        <div class="col-md-10 inputGroupContainer">
                            <form:input path="pesel" cssClass="form-control" />
                        </div>
                    </div>
                    <form:errors path="pesel" cssClass="text-danger form-group row" element="div"/>
                    ...
                    <form:errors path="email" cssClass="text-danger form-group row" element="div"/>

                    <div class="form-group row">
                        <label class="col-md-2 control-label">Year of birth:</label>
                        <div class="col-md-10 inputGroupContainer">
                            <form:input path="yearOfBirth" cssClass="form-control" />
                        </div>
                    </div>
                    <form:errors path="yearOfBirth" cssClass="text-danger form-group row" element="div"/>
