...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <div class="btn-group btn-group-toggle mx-auto mt-5" data-toggle="buttons">
            <a class="btn btn-primary" href="/books">Books</a> <a class="btn btn-primary" href="/propositions">Propositions</a> <a class="btn btn-secondary active">Authors</a> <a class="btn btn-primary" href="/publishers">Publishers</a>
        </div>
                    ...
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <c:forEach items="${authors}" var="author">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="/authors/form?id=${author.id}">Edit</a> <a class="btn btn-primary" href="/authors/delete/${author.id}">Delete</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
                </div>
                <a class="btn btn-primary" href="/authors/form">Add Author</a>
            </div>
        </div>
    </div>
</div>
