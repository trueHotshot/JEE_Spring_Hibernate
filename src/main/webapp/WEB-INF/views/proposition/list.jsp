<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <html>
        <head>
            <title>List of books propositions</title>
...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <div class="btn-group btn-group-toggle mx-auto mt-5" data-toggle="buttons">
            <a class="btn btn-primary" href="/books">Books</a> <a class="btn btn-secondary active" href="/propositions">Propositions</a> <a class="btn btn-primary" href="/authors">Authors</a> <a class="btn btn-primary" href="/publishers">Publishers</a>
        </div>
        <div class="card card-register mx-auto mt-5">
            <div class="card-header">List of books propositions</div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <c:forEach items="${books}" var="book">
                            <c:if test="${book.proposition == true}">
                            <tr>
                                <td><c:out value="${book.title}" /></td>
                                <td><c:out value="${book.description}" /></td>
                                <td>
                                    <a class="btn btn-primary" href="/propositions/edit/${book.id}">Edit</a> <a class="btn btn-primary" href="/propositions/delete/${book.id}">Delete</a></td>
                            </tr>
                            </c:if>
                        </c:forEach>
                        </tbody>
                ...
                <a class="btn btn-primary" href="/propositions/add">Add Book</a>
            </div>
        </div>
    </div>
</div>
