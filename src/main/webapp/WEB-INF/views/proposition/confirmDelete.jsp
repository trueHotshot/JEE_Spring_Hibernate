...
<html>
<head>
    <title>Delete book proposition</title>
...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <div class="card card-register mx-auto mt-5">
            <div class="card-header">Delete book proposition</div>
            <div class="card-body">
                <p>Do you really want to delete book proposition: ${book.title}</p>
                <p><a class="btn btn-primary" href="/propositions/confirmed/${book.id}">Delete</a> <a class="btn btn-secondary" href="/propositions">Cancel</a></p>
            </div>
        </div>
    </div>
</div>
